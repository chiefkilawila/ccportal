...
<head>
    ...
    <title> cc Portal | Members Home </title>
...
/* Sidebar Styles */
 ...
 .card [data-background-color="orange"] {
     background: linear-gradient(60deg, #7386D5, #7386D5);
                ...
                <div class="col-sm-12 col-md-12 user-details">
                    ...
                    <div class="user-info-block">
                        <div class="user-heading">
                            <h3>Dennis Michael</h3>
                            <span class="help-block">Dar es salaam, TZ</span>
                        </div>
                        <ul class="navigation">
                            <li class="active">
                ...
                <nav class="navbar navbar-default" role="navigation">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="/Home/Contact">climate change data entry</a></li>
                        </ul>

                        <ul class="nav navbar-nav navbar-right">
                            <li><a ><strong class="icon-font-size"> Members dashboards</strong></a></li>
                            <li class="dropdown">
        ...
        <div id="wrapper" class="toggled">
            ...
            <div id="sidebar-wrapper">
                <ul class="sidebar-nav">
                    <li class="sidebar-brand"><a>Members Navigation</a>  </li>
                    <li><a href="cso_home.php">Dashboard </a></li>
                    <li><a href="create_new_activity.php">Received Activities </a></li>
                    <li><a href="manage_members.php"> members</a></li>
                    <li><a href="add_new_activity.php">geo-mapping</a></li>
                    <li><a href="manage_activities.php">all activities</a></li>
